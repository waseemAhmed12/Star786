...
<!----------------------user----location---------------------->				
<div id="locations">
   	<ul class="nav zer-padd">
		 <li class="nav-item">
				<a class="nav-link" href="#"><img src="icons/icons8-location-48.png" class="img-location"><span class="location">.Pakistan</span></a>
		 </li>
		 <li class="nav-item">
			    <a class="nav-link" href="#"><img src="icons/icons8-partly-cloudy-day-48.png" class="img-location"></a>
		 </li>
	</ul>
</div>
<!----------------------user----location---------------------->
...
<div class="card text-center" id="profile-card">
	<div class="card-body">
					<h5 class="wel-com">WEL COME</h5>
							<img src="images/<?php echo($UDBIMX); ?>" class="profile text-center" >
					<h6 class="mt-2 user_name"> <?php echo($UDBNX); ?> </h6>
		<span class="badge satas" id="bo-rad"><span>Admin</span></span>
	</div>
</div>
<!--------------------user profile------------------------->
	
<!--------------------sreach ----input----------------->
<form class="forn-sreach sreach_box">
    <div class="form-group">
         <input type="search" placeholder="Search"  id="search-put-in" >
    </div>
</form>
<!--------------------sreach ----input----------------->
...
<div class="row main-div-of-right-side">
		<!----------------main-----row--body-----of----dashborad-------->	
   		<div class="col-sm-6 top-nav-info" >
   			<p>
				<span class="btn btn-sm pb-0 pt-0 small"><span class="small tlink">Home</span></span>
				<span class="btn btn-sm pb-0 pt-0"><span class="small tlink">Attendance</span></span>
				<span class="btn btn-sm pb-0 pt-0"><span class="small tlink">Leave Requistions </span></span>
				
			</p>
   		</div>
   		<div class="col-sm-6 top-nav-info" >
   			<p id="MyClockDisplaytop" class="clock text-right tlink"></p>
   		</div>
</div>
	<!----------------top--nav ---------------------------->
</section>	
