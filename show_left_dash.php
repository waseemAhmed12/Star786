...
<ul class="nav nav-tabs mt-0">
  ...
  <li class="nav-item">
    <a class="nav-link no-rad active2" href="show_left_dash.php">Left Side</a>
  </li>
  <li class="nav-item">
    <a class="nav-link  no-rad" href="show_right_dash.php">Right Side</a>
  </li>
...
<!-- Tab panes -->
	 ...
	 <?php  require "all_set_comp/left_sett.php"; ?>
	 </div>
